...
<html>
    ...
    <body>
        ...
        <form method="post" action="/addclient">
            <input name="clientTitle" id="clientTitle" value="" placeholder="tytul">
            <input name="clientFirstName" id="clientFirstName" value="" placeholder="imie">
            <input name="clientLastName" id="clientLastName" value="" placeholder="nazwiko">
            <input name="clientCompanyName" id="clientCompanyName" value="" placeholder="nazwa firmy">
